...
# Install Kiwi Harness

<Callout type="info" emoji="📦">
  The Kiwi Harness Python package will be published as <code>kiwi</code>
  . It is not released yet, so installation is currently{" "}
  <strong>Coming Soon</strong>.
</Callout>

The Kiwi Harness is the Python SDK and runtime foundation for building your own Super Agent systems.

If you want to compose agents with skills, memory, tools, sandboxes, and subagents inside your own product or workflow, this is the part of Kiwi you will build on.
...
The Kiwi Harness package is **coming soon**.
...
The Harness is designed for developers who want to build their own agent system on top of Kiwi's runtime model.
...
- integrating Kiwi into your own application architecture.

## What to do next

Until the package is released, the best way to understand the Kiwi Harness is to read the conceptual and implementation docs in this section.
