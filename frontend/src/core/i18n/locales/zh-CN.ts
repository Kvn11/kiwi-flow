...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 Kiwi，一个完全开源的超级智能体。通过内置和自定义的 Skills，\nKiwi 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 Kiwi 的潜力。通过自定义技能，Kiwi\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，Kiwi 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 Kiwi 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 Kiwi 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 Kiwi。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 Kiwi 的界面和行为。",
    sections: {
      appearance: "外观",
      memory: "记忆",
      tools: "工具",
    ...
    memory: {
      title: "记忆",
      description:
        "Kiwi 会在后台不断从你的对话中自动学习。这些记忆能帮助 Kiwi 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    credentials: {
      title: "凭据",
      description:
        "为需要登录外部服务的技能管理认证信息。值会以受限权限保存在本地，永远不会回显给你。",
      emptyTitle: "暂无需要凭据的技能",
      emptyDescription: "已启用的技能都没有声明凭据需求。需要认证的技能会自动出现在这里。",
      statusConfigured: "已配置",
      statusUnconfigured: "未配置",
      rowDescriptionConfigured: "全部 {count} 个字段已设置。",
      rowDescriptionUnconfigured: "还有 {count} 个字段未填写。",
      editTitle: "编辑 {skill} 的凭据",
      editDescription: "只有你填写的字段会被更新。留空则保留当前值。",
      fieldEmptyPlaceholder: "请输入值",
      fieldAlreadySet: "已保存一个值。输入新值以替换，留空则保留。",
      showValue: "显示值",
      hideValue: "隐藏值",
      updateSuccess: "凭据已更新",
      clear: "清除",
      clearConfirmTitle: "清除 {skill} 的凭据？",
      clearConfirmDescription: "保存的值和缓存的会话令牌都会被删除。此操作不可撤销。",
      clearSuccess: "凭据已清除",
    },
    skills: {
      title: "技能",
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 Kiwi 根目录下的 `/skills/custom` 文件夹中。",
    ...
    notification: {
      title: "通知",
      description:
        "Kiwi 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
