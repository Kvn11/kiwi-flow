...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to Kiwi, an open source super agent. With built-in and custom skills, Kiwi helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Kiwi. With customized skills,\nKiwi can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Kiwi is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Kiwi could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to Kiwi",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Kiwi faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Kiwi looks and behaves for you.",
    sections: {
    ...
    memory: {
      title: "Memory",
      description:
        "Kiwi automatically learns from your conversations in the background. These memories help Kiwi understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Kiwi.",
    ...
    notification: {
      title: "Notification",
      description:
        "Kiwi only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
