...
from kiwi.agents.middlewares.tool_error_handling_middleware import build_lead_runtime_middlewares
...
from kiwi.config.agents_config import load_agent_config, validate_agent_name
from kiwi.config.app_config import get_app_config
from kiwi.config.memory_config import get_memory_config
from kiwi.config.summarization_config import get_summarization_config
...
def _build_middlewares(config: RunnableConfig, model_name: str | None, agent_name: str | None = None, custom_middlewares: list[AgentMiddleware] | None = None):
    ...
    if app_config.tool_search.enabled:
        from kiwi.agents.middlewares.deferred_tool_filter_middleware import DeferredToolFilterMiddleware
...
def make_lead_agent(config: RunnableConfig):
    ...
    from kiwi.tools.builtins import setup_agent
