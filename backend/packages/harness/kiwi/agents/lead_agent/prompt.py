...
from kiwi.config.agents_config import load_agent_soul
from kiwi.skills import load_skills
from kiwi.skills.types import Skill
from kiwi.subagents import get_available_subagent_names
...
def _start_enabled_skills_refresh_thread() -> None:
    threading.Thread(
        ...
        name="kiwi-enabled-skills-loader",
        daemon=True,
    ).start()
...
Kiwi is an open-source AI agent framework that gained significant traction in early 2026
[citation:GitHub Repository](https://github.com/bytedance/deer-flow). The project focuses on
providing a production-ready agent system with sandbox execution and memory management
[citation:Kiwi Documentation](https://kiwi-flow.dev/docs).
...
- [Kiwi Documentation](https://kiwi-flow.dev/docs) - Technical specifications
...
def _get_memory_context(agent_name: str | None = None) -> str:
    ...
    """
    try:
        from kiwi.agents.memory import format_memory_for_injection, get_memory_data
...
def get_deferred_tools_prompt_section() -> str:
    ...
    """
    from kiwi.tools.builtins.tool_search import get_deferred_registry
...
def apply_prompt_template(subagent_enabled: bool = False, max_concurrent_subagents: int = 3, *, agent_name: str | None = None, available_skills: set[str] | None = None) -> str:
    ...
    prompt = SYSTEM_PROMPT_TEMPLATE.format(
        agent_name=agent_name or "Kiwi 2.0",
