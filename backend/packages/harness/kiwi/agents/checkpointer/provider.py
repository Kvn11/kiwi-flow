...
Usage::
    ...
    from kiwi.agents.checkpointer.provider import get_checkpointer, checkpointer_context
...
from kiwi.config.checkpointer_config import CheckpointerConfig
from kiwi.runtime.store._sqlite_utils import ensure_sqlite_parent_dir, resolve_sqlite_conn_str
...
def get_checkpointer() -> Checkpointer:
    ...
    from kiwi.config.app_config import _app_config
    from kiwi.config.checkpointer_config import get_checkpointer_config
