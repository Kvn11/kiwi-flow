...
from kiwi.agents.middlewares.tool_error_handling_middleware import ToolErrorHandlingMiddleware
from kiwi.agents.thread_state import ThreadState
from kiwi.tools.builtins import ask_clarification_tool
...
def create_deerflow_agent(
    ...
    *,
    ...
    """Create a Kiwi agent from plain Python arguments.
    ...
    *,
    ...
    if feat.sandbox is not False:
        if isinstance(feat.sandbox, AgentMiddleware):
            ...
            from kiwi.agents.middlewares.thread_data_middleware import ThreadDataMiddleware
    ...
    if feat.vision is not False:
        ...
        from kiwi.tools.builtins import view_image_tool
    ...
    if feat.subagent is not False:
        ...
        from kiwi.tools.builtins import task_tool
