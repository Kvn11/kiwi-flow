...
def test_format_container_mount_uses_mount_syntax_for_docker_windows_paths():
    args = _format_container_mount("docker", "D:/kiwi-flow/backend/.kiwi-flow/threads", "/mnt/threads", False)

    assert args == [
        "--mount",
        "type=bind,src=D:/kiwi-flow/backend/.kiwi-flow/threads,dst=/mnt/threads",
    ]
