...
from kiwi.community.infoquest import tools
from kiwi.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("kiwi.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("kiwi.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("kiwi.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/bytedance/python/kiwi-flowv2/kiwi-flow/backend/tests/test_infoquest_client.py
