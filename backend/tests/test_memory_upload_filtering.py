...
from kiwi.agents.memory.message_processing import detect_correction, detect_reinforcement, filter_messages_for_memory
from kiwi.agents.memory.updater import _strip_upload_mentions_from_memory
...
class TestFilterMessagesForMemory:
    ...
    def test_upload_with_real_question_preserves_question(self):
        ...
        msgs = [
            _human(combined),
            _ai("The file contains: Hello Kiwi."),
        ]
        result = filter_messages_for_memory(msgs)
        ...
        assert result[1].content == "The file contains: Hello Kiwi."
