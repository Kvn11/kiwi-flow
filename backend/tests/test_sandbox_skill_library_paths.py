"""Tests for the /mnt/skill-library virtual-path branches in deerflow.sandbox.tools."""
...
def test_is_library_path_recognises_root_and_subpaths():
    with patch("deerflow.sandbox.tools._get_library_container_path", return_value="/mnt/skill-library"):
...
def test_resolve_library_path_maps_to_host(tmp_path: Path):
    with (
        ...
        patch("deerflow.sandbox.tools._get_library_host_path", return_value=str(tmp_path)),
    ):
...
def test_resolve_library_path_raises_when_host_unavailable():
    with (
        patch("deerflow.sandbox.tools._get_library_container_path", return_value="/mnt/skill-library"),
        patch("deerflow.sandbox.tools._get_library_host_path", return_value=None),
    ):
