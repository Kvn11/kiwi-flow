...
{
  "graphs": {
    "lead_agent": "kiwi.agents:lead_agent"
  },
...
```python
from kiwi.config.title_config import TitleConfig, set_title_config
...
# 测试 title 生成
import pytest
from kiwi.agents.title_middleware import TitleMiddleware
...
- [`packages/harness/kiwi/agents/thread_state.py`](../packages/harness/kiwi/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/kiwi/agents/middlewares/title_middleware.py`](../packages/harness/kiwi/agents/middlewares/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/kiwi/config/title_config.py`](../packages/harness/kiwi/config/title_config.py) - 配置管理
- [`config.yaml`](../../config.example.yaml) - 配置文件
- [`packages/harness/kiwi/agents/lead_agent/agent.py`](../packages/harness/kiwi/agents/lead_agent/agent.py) - Middleware 注册
