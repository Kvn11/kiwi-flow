...
:func:`kiwi.runtime.serialization.serialize_channel_values` to
...
from kiwi.config.paths import Paths, get_paths
from kiwi.runtime import serialize_channel_values
...
async def delete_thread_data(thread_id: str, request: Request) -> ThreadDeleteResponse:
    ...
    Cleans Kiwi-managed thread directories, removes checkpoint data,
