...
:class:`kiwi.agents.runs.RunManager` and
:class:`kiwi.agents.stream_bridge.StreamBridge`.
...
from kiwi.runtime import RunRecord, serialize_channel_values
...
class RunCreateRequest(BaseModel):
    ...
    context: dict[str, Any] | None = Field(default=None, description="Kiwi context overrides (model_name, thinking_enabled, etc.)")
