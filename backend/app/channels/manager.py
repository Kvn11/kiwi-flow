"""ChannelManager — consumes inbound messages and dispatches them to the Kiwi agent via LangGraph Server."""
...
async def _ingest_inbound_files(thread_id: str, msg: InboundMessage) -> list[dict[str, Any]]:
    ...
    from kiwi.uploads.manager import claim_unique_filename, ensure_uploads_dir, normalize_filename
...
class ChannelManager:
    """Core dispatcher that bridges IM channels to the Kiwi agent.
