...
def main() -> int:
    try:
        ...
        print()
        print(bold("Welcome to Kiwi Setup!"))
        print("This wizard will help you configure Kiwi in a few minutes.")
        print()
        ...
        write_config_yaml(
            ...
            extra_model_config=llm.provider.effective_extra_config(llm.model_name) or None,
        ...
        print(f"  {cyan('make dev')}        # Start Kiwi")
        print()
