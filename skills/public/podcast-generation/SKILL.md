...
```json
{
  ...
  "locale": "en",
  "lines": [
    {"speaker": "male", "paragraph": "Hello Kiwi! Welcome back to another episode."},
...
- Start with the male host saying a greeting that includes "Hello Kiwi"
...
```json
{
  ...
  "locale": "en",
  "lines": [
    {"speaker": "male", "paragraph": "Hello Kiwi! Welcome back to another fascinating episode. Today we're diving into something that's literally shaping our future - the history of artificial intelligence."},
...
The generated podcast follows the "Hello Kiwi" format:
- Two hosts: one male, one female
- Natural conversational dialogue
- Starts with "Hello Kiwi" greeting
